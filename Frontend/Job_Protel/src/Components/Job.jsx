...
const Job = ({ job }) => {
  ...
  return (
    <div className="p-6 rounded-xl shadow-lg bg-white border border-gray-200 hover:shadow-2xl transition-shadow duration-300 flex flex-col justify-between h-full">
      {/* Top Row */}
      ...
      <div className="flex flex-wrap gap-2 mt-3">
        <Badge className="text-blue-700 font-bold bg-blue-50 border-none">
          {job?.position} Positions
        </Badge>
        <Badge className="text-[#F83002] font-bold bg-orange-50 border-none">
          {job?.jobType}
        </Badge>
        <Badge className="text-[#7209b7] font-bold bg-purple-50 border-none">
          {job?.salary} LPA
        </Badge>
      </div>
      ...
      <div className="flex flex-row gap-2 mt-5">
        <Button
          ...
          variant="outline"
          className="rounded-lg px-6 py-2 hover:bg-gray-100 transition-colors flex-1 text-center"
        >
          Details
        </Button>
